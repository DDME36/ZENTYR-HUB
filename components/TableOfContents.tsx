    ...
    <>
      ...
      >
        ...
        <span className="flex flex-col items-start leading-none">
          ...
          <span className="mt-1 text-[10px] font-medium tabular-nums leading-none text-rose-500">
            {progress}%
          </span>
        </span>
      </motion.button>
      ...
      <aside className="hidden 2xl:block">
        <div className="fixed left-6 top-32 z-20 w-72">
          <motion.div
            ...
            className="flex max-h-[calc(100vh-200px)] flex-col rounded-[2.5rem] border border-gray-200/50 bg-white/70 p-1 shadow-2xl backdrop-blur-xl"
          >
            ...
            <div className="flex items-center gap-3 p-6 pb-4">
              ...
              <h3 className="font-display text-[20px] font-bold leading-7 tracking-[-0.01em] text-gray-800">
                สารบัญ
              </h3>
            </div>
            ...
            <div className="mt-2 border-t border-gray-100/50 p-6 pt-0">
              <div className="mt-4 flex items-center justify-between text-[10px] font-bold uppercase leading-none tracking-[0.16em] text-gray-400">
                <span>Reading</span>
        ...
        {isOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed inset-x-0 bottom-0 z-[160] flex max-h-[min(82dvh,44rem)] flex-col rounded-t-[28px] bg-white shadow-2xl sm:inset-x-4 sm:bottom-4 sm:rounded-[32px] 2xl:hidden"
              role="dialog"
              aria-modal="true"
              aria-labelledby="mobile-toc-title"
            >
              <div className="mx-auto mb-1 mt-3 h-1 w-10 rounded-full bg-gray-200 sm:mt-4" />
              <div className="flex items-center justify-between px-5 py-4 sm:px-7 sm:py-5">
                <h3
                  id="mobile-toc-title"
                  className="font-display text-[20px] font-bold leading-7 tracking-[-0.01em] text-gray-800 sm:text-[22px]"
                >
                  สารบัญ
                </h3>
                <button
                  ...
                  onClick={() => setIsOpen(false)}
                  className="flex h-11 w-11 items-center justify-center rounded-full bg-gray-100 text-gray-500 transition-colors hover:bg-gray-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-rose-400"
                >
                  <X size={24} />
                </button>
              </div>
