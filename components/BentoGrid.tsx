...
export const BentoGrid = ({ posts, isDark = false }: BentoGridProps) => {
  return (
    <>
      <div className="mx-auto grid max-w-6xl auto-rows-[160px] grid-cols-1 gap-4 px-4 py-12 sm:auto-rows-[176px] sm:grid-cols-2 md:auto-rows-[168px] md:grid-cols-4 md:gap-5 lg:gap-6">
        ...
        <Card
          ...
          BgIcon={Brain}
          delay={0}
          className="group relative col-span-1 row-span-2 !border-none !bg-gradient-to-br from-emerald-500 to-teal-600 !text-white shadow-[0_10px_30px_-5px_rgba(16,185,129,0.3)] sm:col-span-2 md:col-span-2 lg:col-span-2"
        >
        ...
        <Card
          ...
          BgIcon={User}
          delay={0.06}
          className="col-span-1 row-span-2 !border-none !bg-gradient-to-br from-gray-800 to-gray-900 !text-white shadow-[0_10px_30px_-5px_rgba(0,0,0,0.18)] sm:col-span-1"
        >
          <div className="flex h-full flex-col items-center justify-between text-center">
            ...
            <div className="mt-2 w-full cursor-pointer rounded-xl bg-white py-2 text-xs font-bold text-gray-900 shadow-sm transition-transform duration-300 hover:scale-105 hover:bg-gray-100">
              ประวัติและผลงาน
            </div>
          </div>
        </Card>
        ...
        <Card
          ...
          BgIcon={Gamepad2}
          delay={0.1}
          className="col-span-1 row-span-2 !border-none !bg-gradient-to-br from-blue-500 to-indigo-600 !text-white shadow-[0_10px_30px_-5px_rgba(59,130,246,0.3)] sm:col-span-1"
        >
          <div className="flex h-full flex-col items-center justify-between text-center">
            ...
            <div className="mt-2 w-full cursor-pointer rounded-xl border border-white/30 bg-white/20 py-2 text-xs font-bold text-white transition-all duration-300 hover:bg-white/30">
        ...
        <Card
          ...
          BgIcon={Mic2}
          delay={0.14}
          className="col-span-1 row-span-1 !border-none !bg-gradient-to-br from-rose-500 to-red-600 !text-white shadow-[0_10px_30px_-5px_rgba(244,63,94,0.3)] sm:col-span-2 sm:!p-5 md:col-span-2"
        >
        ...
        <Card
          ...
          BgIcon={Bell}
          delay={0.18}
          className="col-span-1 row-span-1 !border-none !bg-gradient-to-br from-indigo-500 to-purple-600 !text-white shadow-[0_10px_30px_-5px_rgba(99,102,241,0.3)] sm:col-span-2 sm:!p-5 md:col-span-2"
        >
          <div className="flex h-full flex-col justify-between">
            <div className="flex items-start justify-between">
              <div className="mb-1 flex items-center gap-2">
        ...
        <Card
          ...
          priority={true}
          delay={0.22}
          className="col-span-1 row-span-1 !border-none !text-white shadow-[0_10px_30px_-5px_rgba(0,0,0,0.2)] sm:col-span-2 md:col-span-1"
        >
          <div className="flex h-full flex-col justify-between">
            <div className="flex items-start justify-between">
              <div>
        ...
        <Card
          ...
          BgIcon={Heart}
          delay={0.26}
          className="col-span-1 row-span-1 !border-none !bg-gradient-to-br from-pink-500 to-rose-600 !text-white shadow-[0_10px_30px_-5px_rgba(244,63,94,0.3)]"
        >
        ...
        <Card
          ...
          BgIcon={Music}
          delay={0.3}
          className="col-span-1 row-span-1 !border-none !bg-gradient-to-br from-pink-400 via-rose-400 to-purple-500 !text-white shadow-[0_10px_30px_-5px_rgba(236,72,153,0.3)]"
        >
          <div className="flex h-full flex-col items-center justify-center text-center">
        ...
        <Card
          ...
          delay={0.34}
          className="col-span-1 row-span-1 !border-none !bg-gray-800 !text-white shadow-[0_10px_30px_-5px_rgba(0,0,0,0.2)]"
        >
          <div className="flex h-full flex-col items-center justify-center text-center">
        ...
        <Card
          ...
          BgIcon={Terminal}
          delay={0.38}
          className="col-span-1 row-span-1 !border-none !bg-gradient-to-r from-slate-900 to-slate-800 !text-white shadow-[0_10px_30px_-5px_rgba(0,0,0,0.25)]"
        >
          <div className="flex h-full flex-col items-center justify-center text-center">
        ...
        {/* Articles Section - ปรับให้เข้ากับธีมมืดและสว่าง */}
        <Card
          BgIcon={BookOpen}
          delay={0.42}
          className={cn(
          ...
          <div className="flex h-full flex-col">
            ...
            >
              ...
              <ArrowUpRight
                size={14}
                className={cn(
                  '-translate-x-2 opacity-0 transition-all group-hover/header:translate-x-0 group-hover/header:opacity-100',
                  ...
                  >
                    <span
                      className={cn(
                        ...
                        isDark ? 'bg-cyan-400' : 'bg-rose-400'
                      )}
                    />
